...
func Test_Put(t *testing.T) {
	...
	if response.Get("url").String() != "/put" {
		t.Error("Expected url /put, got", response.Get("url").String())
	}

	if response.Get("method").String() != "PUT" {
		t.Error("Expected method PUT, got", response.Get("method").String())
	}
