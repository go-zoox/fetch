...
func Test_Patch(t *testing.T) {
	...
	if response.Get("url").String() != "/patch" {
		t.Error("Expected url /patch, got", response.Get("url").String())
	}

	if response.Get("method").String() != "PATCH" {
		t.Error("Expected method PATCH, got", response.Get("method").String())
	}
